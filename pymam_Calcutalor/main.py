...
# my name is TanvirislamBaizid
# about me devyeasir.info
# Project 1 just test
# Calculator == use tkinter package
...
root = tkinter.Tk()
root.title("myproject Calculator")
# main
expression = " BY>"                           # Hello > Python Project
...
# Create GUI
label_result = tkinter.Label(root, text="")         # main label is title
label_result.grid(row=0, column=0, columnspan=4)

button_1 = tkinter.Button(root, text="1", command=lambda: add("1"))  # button one use text,command
button_1.grid(row=1, column=0)

button_2 = tkinter.Button(root, text="2", command=lambda: add("2"))  #///////////////////
button_2.grid(row=1, column=1)

button_3 = tkinter.Button(root, text="3", command=lambda: add("3")) # pagla_mama-web-3 install Now ?
...
print("Welcome to my prject-1 form Tanvir  \n Islam Baizid  myproject Calculator \n about me devyeasir.info iam   full-stack Web developer  ")
